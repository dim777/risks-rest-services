...
public class RisksRestServicesApplication {
	private static final Logger log = LoggerFactory.getLogger(RisksRestServicesApplication.class);
	...
	public static void main(String[] args) throws IOException {
		...
		SpringApplication.run(RisksRestServicesApplication.class, args);
	}
}
